        ...
        <div className='container my-4'>
            ...
            <div className='row'>
                <div className='col-lg-4 col-md-6 col-12 text-center rounded p-4'>
                    <img className='rounded mb-3' src="https://themes.flexipress.xyz/transpress/wp-content/uploads/2016/05/team2-min-100x100.jpg" alt="" />
                ...
                <div className='col-lg-4 col-md-6 col-12 text-center rounded p-4'>
                    <img className='rounded mb-3' src="https://themes.flexipress.xyz/transpress/wp-content/uploads/2016/05/team1-min-100x100.jpg" alt="" />
                ...
                <div className='col-lg-4 col-md-6 col-12 text-center rounded p-4'>
                    <img className='rounded mb-3' src="https://themes.flexipress.xyz/transpress/wp-content/uploads/2016/05/team3-min-100x100.jpg" alt="" />
